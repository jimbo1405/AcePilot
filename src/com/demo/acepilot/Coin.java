...
public class Coin {
	private double coin_positionX;	
	private double coin_positionY;	
...
//	            }    
	...
	public double getCoin_positionX() {
		return coin_positionX;
	}

	public void setCoin_positionX(double coin_positionX) {
		this.coin_positionX = coin_positionX;
	}

	public double getCoin_positionY() {
		return coin_positionY;
	}
